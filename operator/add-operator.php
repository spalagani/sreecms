            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="exampleInputEmail1">Operator Mobile Number</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Operator Mobile Number">
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">Operator Email</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Operator Email">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Operator Address</label>
                  <input type="email" class="form-control"  id="exampleInputEmail1" placeholder="Operator Address">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Operator ID Proof</label>
                  <input type="text" id="exampleInputFile">

                  <p class="help-block">&nbsp;</p>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Operator ID Proof Attachment</label>
                  <input type="file" id="exampleInputFile">
