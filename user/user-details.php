                                                ...
                                                <div class="box box-widget widget-user-2">
                                                    ...
                                                    <div class="box-footer no-padding">
                                                        <ul class="nav nav-stacked" style="background-color:#f7f7f7">
                                                            ...
                                                            <li><a href="#">Current Package <span class="pull-right"><?php echo !empty($finalArr['Package_Name'])?$finalArr['Package_Name']:''; ?></span></a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 text-center">
                                                            ...
                                                            <a href="<?php echo $serverurl."user/changepackage.php?id=$searchTerm"; ?>" style="text-align:center;display:inline-block;" class="btn btn-primary">Change Package</a>
                                                            <a href="<?php echo $serverurl."user/add-comments.php?id=$searchTerm"; ?>" style="text-align:center;margin-top:5px;margin-left:10px;" class="btn btn-primary">Add Comments</a>
                                                        </div>
                                                        <div class="col-md-2"></div>
                                                    </div>
                                                </div>
